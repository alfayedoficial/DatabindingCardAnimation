...
package com.promoclick.databindingcard.payment;
...
/**
 * ApiPayment object used to send create and update session requests. Conforms to the singleton
 * pattern.
 *
...
public class ApiPayment {
    ...
    private static final ApiPayment INSTANCE = new ApiPayment();
    ...
    public static ApiPayment getInstance() {
        return INSTANCE;
    }
